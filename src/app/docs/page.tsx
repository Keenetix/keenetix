...
export default function DocsPage() {
  return <><SiteHeader /><main>
    <section className="docs-hero"><p className="section-label">Keenetix documentation</p><h1>Protocol reference<br /><em>for builders.</em></h1><p>Everything needed to understand the economic primitives behind autonomous work.</p><div className="docs-jump"><a href="#architecture">Architecture</a><a href="#commitment">Commitment schema</a><a href="#verification">Verification</a><a href="#lifecycle">Lifecycle</a><a href="#specifications">Specifications</a></div></section>
    <section className="docs-layout">
      <aside className="docs-sidebar"><p>ON THIS PAGE</p><a href="#architecture">Protocol architecture</a><a href="#commitment">Commitment schema</a><a href="#verification">Verification methods</a><a href="#lifecycle">Lifecycle reference</a><a href="#specifications">Protocol specifications</a><Link href="/developers">Developer onboarding ↗</Link></aside>
